const ICON_PATHS = {
    ...
    'rhombus':       '<polygon points="12 2 22 12 12 22 2 12" fill="none"/>',
...
export default function Icon({ name, size = 20, color = 'currentColor', spin, style: extraStyle }: {
    name: string;
    size?: number;
    color?: string;
    spin?: boolean;
    ...
    const paths = (ICON_PATHS as Record<string, string>)[name] || '';
